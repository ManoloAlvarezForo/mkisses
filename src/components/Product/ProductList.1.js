    ...
    render() {
        return (
            <View style={styles.customCard}>
                <CardItem style={styles.contentCard}>
                    <Left>
                        <Body>
                ...
                <CardItem style={styles.contentCard}>
                    ...
                    <Right>
                        <Button small style={{ borderRadius: 5, backgroundColor: '#FF006E' }} block>
                            <Text style={{ fontSize: 15, color: 'white', fontWeight: 'bold', marginLeft: 10, marginRight: 0 }}>Add to </Text>
